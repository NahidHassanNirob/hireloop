  ...
  const handleSignUp = async () => {
    ...
    const { data, error } = await authClient.signUp.email(
      ...
      },
      {
        ...
        onError: (er) => {
          console.log(er, "errrr");
          toast.error(er?.error?.message || "something went wrong");
        },
      },
    );
    ...
    <div className="flex min-h-screen items-center justify-center bg-[#050505] px-6 py-12">
      <div className="w-full max-w-md p-8 border border-white/10 rounded-3xl bg-[#1a1a1a]">
        ...
        <div className="relative my-8 text-center">
          ...
          <span className="relative px-4 bg-[#1a1a1a] text-gray-500 text-xs uppercase tracking-widest">
            Or continue with
          </span>
        </div>
