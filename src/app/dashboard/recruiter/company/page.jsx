...
export default function CompanyProfile() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error(error);
            alert("Failed to update profile. Please check your API key.");
        } finally {
            setLoading(false);
        }
    };
        ...
        return (
            <div className="max-w-3xl mx-auto my-8 bg-zinc-950 p-8 border border-zinc-900 rounded-xl space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 text-zinc-400">
                    <p>Industry: <span className="text-white">{company.industry}</span></p>
                    <p>Location: <span className="text-white">{company.location}</span></p>
                    <p>Website: <span className="text-blue-400">{company.websiteUrl}</span></p>
                </div>
